...
improve your online search experience, privacy, security, and autonomy with some of the following setup (or better yet, do your own research)

browser: [firefox](https://www.firefox.com/en-US/channel/desktop/developer/) / [brave](https://brave.com/) / [librewolf](https://librewolf.net/)

search engine: [ddg](https://duckduckgo.com/) / [ecosia](https://www.ecosia.org/) / [brave](https://search.brave.com/) 

adblock: [ublock origin](https://github.com/gorhill/uBlock#ublock-origin)

passwords: [bitwarden](https://bitwarden.com/), or other *non-browser password manager*.

{{< spoiler show="why this is so important">}}
these browsers allow you to use any search engine of your choice with improved privacy and customization. leaving google/microsoft/apple browsing is the first thing everyone should do today to widen their sources of information. adblockers (such as ublock) reduce the amount that websites are able to track you, as well as stifling the manipulative nature of advertising (which affects everyone, regardless of our awareness) and avoiding malicious sites. use an independant password manager rather than browser defaults.
{{< /spoiler >}}
...
[COCA](https://www.english-corpora.org/coca/): understand the building blocks of language using a database of 1b+ words of english text

[IPA](https://www.ipachart.com/): hear individual phonemes, the sound blocks of language. english actually has 20 vowels

[toki pona](https://tokipona.org/): conlang with 120 core words and a lovely community
...
google streetview is a fantastic resource for seeing what the rest of the world looks like, and i highly recommend clicking around using [map making app](https://map-making.app/). gamify it with [worldguessr](https://www.worldguessr.com/). in either case, you'll learn a ton

[osm](https://www.openstreetmap.org): open-source maps data for power users; [search osm data](https://osm-search.bellingcat.com/) 
